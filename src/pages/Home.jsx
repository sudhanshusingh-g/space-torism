...
function Home() {
  return (
    ...
    h-screen bg-no-repeat bg-center bg-cover flex flex-col"
    >
        ...
        <div className=" h-[80%] w-[90%] lg:w-[80%] flex items-end ">
          <div className=" flex items-center flex-col lg:flex-row gap-4">
            <div className="flex flex-col gap-4 lg:w-[50%] items-center lg:items-start">
              <p className="text-blue-300/50 uppercase">
                So, You Want To Travel To
              </p>
              <h1 className="text-white uppercase text-8xl">Space</h1>
              <p className="text-blue-300/70 leading-7 text-center md:w-[64%] lg:w-[100%] lg:text-left">
            ...
            <div className="flex justify-end flex-1 group">
              ...
              transition-all duration-300 flex items-center justify-center">
                <button className="bg-white h-48 w-48 lg:h-56 lg:w-56 rounded-full text-2xl">
                  Explore
                </button>
              </div>
            </div>
